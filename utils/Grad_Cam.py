...
def Grad_Cam_process(model_path, image_path):
    ...
    target_layers = [yolo_model.model[-3]]
    ...
    cv2.imwrite("output/final_output6.jpg", cv2.cvtColor(visualization, cv2.COLOR_RGB2BGR))

if __name__ == "__main__":
    model_path = "/home/easemyai/dipesh_folder/runs/detect/train/weights/best.pt"
    image_path = "/home/easemyai/dipesh_folder/task/dataset/images/val/hard_hat_workers260.png"
